<?php 
  ...
  $resultado= $conexion->query("select * from redes")or die($conexion->error);
?>
<!DOCTYPE html>
<html lang="es">
<head>
  <head>
    <title><?= TITLE_WEB; ?> - Redes Sociales</title>
    <meta charset="utf-8"/>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-4">
            <h1 class="m-0 text-dark">Redes Sociales</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <table id="example" class="table table-striped table-bordered table-hover" style="max-width: 700px;">
            <thead>
              <tr>
                ...
                <th style="max-width: 400px;">Link</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <td>
                  <img src="../images/redes/<?php echo $f['imagen']; ?>" alt="" width="100px">               
                </td>
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditar" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="../php/editarredes.php" method="POST" enctype="multipart/form-data">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditar">Editar Redes Sociales</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="link">Link <small class="text-muted">(Link de la pagina del post)</small></label>
