...
<html lang="es">
  <head>
    <title><?= TITLE_WEB; ?> - Usuarios</title>
    <meta charset="utf-8"/>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  data-apellido="<?php echo $f['apellido']; ?>" 
                  data-telefono="<?php echo $f['telefono']; ?>"  
                  data-email="<?php echo $f['email']; ?>" 
                  data-nivel="<?php echo $f['nivel']; ?>" 
                  data-password="<?php echo openssl_decrypt($f['password'],COD,KEY); ?>"
      ...
      <form action="../php/editarusuario.php" method="POST">
        ...
        <input type="hidden" id="idEdit" name="id">
          ...
          <div class="form-group">
            ...
            <input type="text" name="apellido" placeholder="Apellido" id="apellidoEdit" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="telefonoEdit">Teléfono</label>
            <input type="text" name="telefono" id="telefonoEdit" class="form-control" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="password" placeholder="" id="passwordEdit" class="form-control" required>
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
