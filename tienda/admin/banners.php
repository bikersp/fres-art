<?php 
  ...
  $resultado= $conexion->query("select * from banners")or die($conexion->error);
?>
<!DOCTYPE html>
<html lang="es">
<head>
  <head>
    <title><?= TITLE_WEB; ?> - Banners</title>
    <meta charset="utf-8"/>
        ...
        <div class="table-responsive">
          <table id="example" class="table table-striped table-bordered table-hover" style="max-width: 700px;">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <img src="../images/banners/big/<?php echo $f['imagen']; ?>" alt="" width="100px">               
                </td>
                <td>
                  <img src="../images/banners/<?php echo $f['imagen2']; ?>" alt="" width="90px">               
                </td>
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditar" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="../php/editarbanner.php" method="POST" enctype="multipart/form-data">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditar">Editar Banner</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="imagen">Imagen Grande<small class="text-muted">(width: 1081px)(jpg o png)</small></label>
          <input type="file" name="imagen" id="imagen" class="form-control">
        </div>
        <div class="form-group">
          <label for="imagen2">Imagen Pequeña<small class="text-muted">(width: 482px)(jpg o png)</small></label>
